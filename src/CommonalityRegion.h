#ifndef COMMONALITY_REGION_H
#define COMMONALITY_REGION_H
...
/** Heuristic that finds a region of commonality in a sequence.
*/
class CommonalityRegion : public Heuristic {
...
protected:
    ...
    */
    CommonalityRegion(const int refESTidx, const std::string& outputFileName);
