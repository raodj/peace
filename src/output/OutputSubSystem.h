...
class OutputSubSystem : public SubSystem {
    ...
    using SubSystem::initializeSubComponents;    
public:
    /** The constructor.
    ...
    */
    ...
    /** Initialize sub-components in the output sub-system.
        ...
        be processed is ready and available.  In addition, the
        information in the RuntimeContext is complete.  This
        information is needed for the SAMWriter to register itself
        with the assembler.  This method initializes the SAMWriter
        object.
...
private:
	...
	*/
	...
	/** Component to write genome-assembler generated contigs in SAM
        file format.

		This component is part of the OutputSubSystem. It deals with
		serializing the contigs generated by a genome-assembler (such
		as BatonAssembler) to a given file. The contigs are written in
		SAM file format.
	*/
	SAMWriter samWriter;

	/** Component to write genome-assembler generated contigs in ACE
        file format.
