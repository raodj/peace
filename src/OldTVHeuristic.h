#ifndef OLD_TV_HEURISTIC_H
#define OLD_TV_HEURISTIC_H
...
*/
class OldTVHeuristic : public OldUVHeuristic {
...
protected:
    /** The default constructor.
        ...
        ignored.
    */
    OldTVHeuristic(const std::string& outputFileName);
	...
	this heuristic.
        ...
        value of OldUVHeuristic::bestMatchIsRC flag) to analyze
    ...
    */
    ...
    int countCommonWords(const int otherEST, Encoder encoder,
        ...
        register int hash      = 0;
        for(int i = 0; (i < OldUVHeuristic::v - 1); i++) {
        ...
        for(int i = OldUVHeuristic::v - 1; (i < otherESTLen); i++) {
            hash = encoder(hash, otherSeq[i]);
