...
public:
    ...
    */
	...
	\param[in] direction The direction value generated by a given
        EST analyzer indicating whether this node and its parent node
	are related by reverse-complementing (-1) or not (1).
    */
