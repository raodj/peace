#ifndef ADAPTIVE_MST_CLUSTER_MAKER_H
#define ADAPTIVE_MST_CLUSTER_MAKER_H
...
*/
class AdaptiveMSTClusterMaker : public MSTClusterMaker {
...
public:
    ...
    */
    virtual ~AdaptiveMSTClusterMaker();
...
private:    
    ...
    */
    AdaptiveMSTClusterMaker(ESTAnalyzer *analyzer);
};
