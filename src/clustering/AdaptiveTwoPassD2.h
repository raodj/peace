...
public:
    ...
    */
    ...
    /** Method to begin EST analysis.
		...
		\note This method short circuits initialization and avoid
		reinitialization.
...
protected:
    ...
    */
    inline float getInvalidMetric() const { return 400.0f * (noNormalize ? 1 : (1.0f / threshold)); }
    ...
    */    
    ...
    /** The threshold score below which two ESTs are considered
        ...
        is set to 0.  This value can be overridden by the user with
    ...
    */
    ...
    /** The threshold score above which two ESTs are considered
        ...
        \c --maxThreshold command line argument.
    */
    int maxThreshold;
...
private:
    ...
    */
    ...
    /** The hash value to be used for a word containing 'N'.
        ...
        Initialized to MapSize (the size of the delta table).  This is
        a convenience instance variable used to reudce the number of
        parameters passed between helper methods in this class.
    */
	int NHash;
    ...
    */
    ...
    /** Method to dynamically compute parameters such as frame size
        and threshold.  Sets these parameters to their (hopefully)
        optimum values for better clustering of data sets with wide
        variation in length, such as data generated by 454 pyrosequencing.
        
        \param[in] otherEST A pointer to the EST with which the
        reference EST is to be compared.
    */
    void updateParameters(const EST* otherEST);
