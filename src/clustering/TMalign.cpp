...
double detailed_search(double **r1, double **r2, double **xtm, double **ytm,
                       double **xt, double **x, double **y, int UNUSED(xlen),
                       int ylen, 
...
double detailed_search_standard( double **r1, double **r2,
    double **xtm, double **ytm, double **xt, double **x, double **y,
                                 int UNUSED(xlen), int ylen, int invmap0[], double t[3], double u[3][3],
...
double get_score_fast( double **r1, double **r2, double **xtm, double **ytm,
                       double **x, double **y, int UNUSED(xlen), int ylen, int invmap[],
...
double DP_iter(double **r1, double **r2, double **xtm, double **ytm,
    ...
    int g1, int g2, int iteration_max, double local_d0_search,
               double UNUSED(D0_MIN), double Lnorm, double d0, double score_d8)
{
...
void output_results(
    ...
    const double TM_ali, const double rmsd_ali, const double UNUSED(TM_0),
    const double UNUSED(d0_0), const double d0A, const double d0B,
...
double standard_TMscore(double **r1, double **r2, double **xtm, double **ytm,
                        double **xt, double **x, double **y, int UNUSED(xlen), int ylen, int invmap[],
    int& L_ali, double& RMSD, double D0_MIN, double Lnorm, double d0,
                        double UNUSED(d0_search), double score_d8, double t[3], double u[3][3],
    const int mol_type)
{
    D0_MIN = 0.5;
    Lnorm = ylen;
...
int main_tmalign(int argc, char *argv[])
{
    ...
    if (dir_opt.size())
        for (int i=0;i< (int) chain1_list.size();i++)
    ...
    int    xchainnum,ychainnum = -1;// number of chains in a PDB file
...
double getTMalignScore(const std::string& xname, const std::string& yname) {
    ...
    /* print result */
    // std::cout << "TM-score: " << TM1 << ", and " << TM2 << std::endl;
