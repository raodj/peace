...
// default params
int OldUVHeuristic::u           = 6;
int OldUVHeuristic::v           = 8;
int OldUVHeuristic::wordShift   = 8;
int OldUVHeuristic::BitMask     = 0;
int OldUVHeuristic::passes      = 3;
...
arg_parser::arg_record OldUVHeuristic::argsList[] = {
    {"--uv_u", "u (number of v-word matches) (default=4)",
     &OldUVHeuristic::u, arg_parser::INTEGER},
    {"--uv_v", "v (length of common words) (default=8)",
     &OldUVHeuristic::v, arg_parser::INTEGER},
    {"--uv_wordShift", "Word Shift (default=16)",
     &OldUVHeuristic::wordShift, arg_parser::INTEGER},
    {"--uv_passes", "Number of Passes (default=3)",
     &OldUVHeuristic::passes, arg_parser::INTEGER},
    {NULL, NULL, NULL, arg_parser::BOOLEAN}
};

OldUVHeuristic::OldUVHeuristic(const std::string& name,
...
void
OldUVHeuristic::showArguments(std::ostream& os) {
    // Use a arg parser object to conveniently display common options.
    arg_parser ap(OldUVHeuristic::argsList);
    os << ap;
}

bool
OldUVHeuristic::parseArguments(int& argc, char **argv) {
    arg_parser ap(OldUVHeuristic::argsList);
...
int
OldUVHeuristic::setReferenceEST(const int estIdx) {
...
void
OldUVHeuristic::computeHash(const int estIdx) {
...
bool
OldUVHeuristic::runHeuristic(const int otherEST) {
