 ...
 *
 * This interface is used to announce the fact that a given tab 
 * has been deleted by the user. This listener is a bit peculiar
...
public interface DnDTabListener {
	 ...
	 * 
	 * @param tab The tab that was removed from a DnDTabbedPane.
	 */
	public void tabDeleted(Component tab);
}
