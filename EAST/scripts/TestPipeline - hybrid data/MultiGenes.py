...
if dataType == "sanger":
    ...
    PerOf454 = 0.4
    PerOfIllumina = 0.2
    numOfEstSanger = str(int(PerOfSanger*coverage*meanLen/800))
    numOfEst454 = str(int(PerOf454*coverage*meanLen/230)*num_genes)
    numOfEstIllumina = str(int(PerOfIllumina*coverage*meanLen/62)*num_genes)
...
usedTime = subprocess.Popen(['./singleTestForMulti.pl', peaceGeneFile, numOfEstSanger, str(errorRate), uniqueId, useQualityFile, baseDir, dataType, numOfEst454, numOfEstIllumina], stdout=subprocess.PIPE).communicate()[0].strip()
