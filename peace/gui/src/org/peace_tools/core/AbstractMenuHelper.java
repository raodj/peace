...
public abstract class AbstractMenuHelper implements TableModelListener {
	...
	public enum ActionType {
		...
		COMPUTE_MST, COMPUTE_CLUSTERS, EAST_ASSEMBLY, CLUSTER_AND_EAST_ASSEMBLY, BATON,
		START_JOB_MONITOR, STOP_JOB_MONITOR, 
		SHOW_JOB_DETAILS, ABORT_JOB, REMOVE_JOB, 
		SHOW_JOBS_ON_SERVER, SHOW_MY_JOBS_ON_SERVER,
		CREATE_SUBLIST, DELETE_SUBLIST,// JOB_MENU
		...
		GENERATE_READS_VIA_MULTISIM, CONFIGURE_DECAGON // DECAGON MENU
	}
