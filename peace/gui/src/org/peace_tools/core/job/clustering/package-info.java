/**
 * Contains the classes associated with the clustering job wizard.
 * 
 * <p>
 * This package contains the classes associated with the clustering
 * job wizard. The clustering job wizard guides the user through 
 * the process of launching a new job (to compute MST and clustering)
 * on a server.</p> 
 *
