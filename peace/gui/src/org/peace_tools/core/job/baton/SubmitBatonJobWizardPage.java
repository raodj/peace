 ...
 * a Baton job. The base class performs all the core tasks.
 ...
 */
public class SubmitBatonJobWizardPage extends GenericSubmitJobWizardPage { 
	/**
	 ...
	 */
	public SubmitBatonJobWizardPage(BatonJobWizard wizard) {
	 ...
	 */
	private final BatonJobWizard wizard;
