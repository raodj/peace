...
public:
    ...
    */
    ...
    /** Add valid command line parameters for this analyzer.
    ...
    */
    ...
    /** Method to begin EST analysis.
		...
		\note This method uses Component::isInitialized() method to
...
protected:
    /** Analyze and obtain a distance metric.
        ...
        \param[in] otherEST A pointer to the the EST with which the
...
private:
    ...
    */
    float runD2Asymmetric(const EST* otherEST, int* s1MinScoreIdx,
                          int* s2MinScoreIdx); 	
    ...
    */
    float runD2Bounded(const EST *otherEST, int sq1Start, int sq1End, 
