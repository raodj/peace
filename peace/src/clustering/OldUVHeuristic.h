#ifndef OLD_UV_HEURISTIC_H
#define OLD_UV_HEURISTIC_H
...
*/
class OldUVHeuristic : public Heuristic {
...
protected:
    ...
    */
    OldUVHeuristic(HeuristicChain *chain, const std::string& name);
    ...
    */
    ...
    /** Method to compute the <i>u/v</i> hash values for a given EST.
        ...
        \param[in] est Pointer to an immutable EST object for which
        the hash values are to be generated.
    */
    ...
    */
    ...
    /** Convenience instance variable to hold length of other (not
        reference) EST being compared.

        This instance variable is used to hold the length of an cDNA
        fragment with which the reference EST is being currently
        compared.

        \note This instance variable can be removed and replaced with
        a local variable (or call to EST::getSequenceLength()).
    */
	int otherESTLen;
