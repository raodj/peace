...
public:
    ...
    */
    //virtual int analyze(); // This is provided by FWAnalyzer
...
protected:
    ...
    */
    ...
    /** Helper method to build reference and complement hash maps.
        ...
        maps using the createD2HashMap() method and pouplates the
        custom ESTD2Data object associated with the EST.
