...
public:
    /**
       A simple inner class to encapsulate information generated by
       the local and global sequence alignment methods in this class.
       This class has been introduced to streamline management of
       various interrelated information generated via
       
    */
    class AlignmentResult {
    public:
        /**
           The alignment score generated by a given alignment
           algorithm.  The score could be a Needleman-Wunsch score for
           global alignments or a Smith-Waterman score for local
           alignments.
        */
        int alignScore;

        /**
           The A-score generated based on the global or local
           alignments.

           A-score = (2 * seq1_length) - (#aScoreDelPen *
           num_of_deletions) - (#aScoreInsPen * num_of_insertions) -
           (#aScoreSubPen * num_of_SNPs)
        */
        int aScore;

        /**
           The first (of the two) aligned nucleotide sequence.  This
           value is generated by one of the alignment algorithms.  The
           result is a global or a locally aligned sequence.
        */
        std::string alignedSeq1;

        /**
           The second (of the two) aligned nucleotide sequence.  This
           value is generated by one of the alignment algorithms.  The
           result is a global or a locally aligned sequence.
        */        
        ...
        /**
           A convenience comparison operator for comparing two objects
           based on their alignment score.

           \param[in] rhs The right hand side of the comparison
           operation.

           \return This method returns \c true if \c this object's
           alignScore is less than rhs.alignScore.  Otherwise it
           returns \c false.
        */
        bool operator<(const AlignmentResult& rhs) const {
            return (alignScore < rhs.alignScore);
        }
    };
    ...
    */
    ...
    /** Obtain result from performing Needleman-Wunsch global
        ...
        \note Avoid using this mehtod on long nucleotide sequences as
        it is not memory optimal.  Instead, favor the overloaded
        method that uses a \i bandwidth to limit the memory usage
        instead of this method for long sequences.
    ...
    */
    ...
    /** Obtain result from performing Needleman-Wunsch global
        alignment using a fixed number of entries around the diagonal.
        ...
        However, this method uses a bandwidth around the diagonal to
        optimize the memory and number of diagonal entries computed to
        optimize the memory and time used by this method.
        ...
        generated by the algorithm as it tries to determine the best
        possible global alignment for the two given sequences. The
        scores ultimately depend on the scoring parameters set for \c
        this object.
   ...
   int getNWAlignment(const std::string& seq1, const std::string& seq2,
    ...
    /** Obtain result from performing Needleman-Wunsch global
        alignment using a fixed number of entries along the diagonal.
        
        This method can be used to perform global alignment on a given
        pair of nucleotide sequences and returns the results from
        performing the alignment in an encapsulated object for
        convenience.  This method essentially calls the overloaded
        getNWAlignment method in this class to perform the actual
        alignment.  Refer to the documentation on the overloaded
        getNWAlignment method for details.
        ...
        \param[out] alignResult Reference to an AlignmentResult object
        that contains the results of performing the global
        alignment.
    ...
    */
    int getNWAlignment(const std::string& seq1, const std::string& seq2,
                       const int bandwidth, AlignmentResult& alignResult) const;
    ...
    /** Obtain result from performing Smith-Waterman local
        ...
        \param[in] seq1 The first nucleotide sequence involved in the
        local alignment.  If applicable, this should preferably be the
        the reference gene/transcript.
        
        \param[in] seq2 The second nucleotide sequence involved in the
        local alignment.  If application, this should preferably be
        the assembler-generated contig.
               
        \param[out] alignScore The final \i best alignment score
        generated by the algorithm as it tries to determine the best
        possible local alignment for the two given sequences. The
        scores ultimately depend on the scoring parameters set.
        ...
        sequences.  Note that the first sequence is assumed to be the
        reference sequence for the computations.  The A-scores
        computed by this method are influenced by the scoring
        parameters (see setAScoreParams() method).  The A-score is
        computed using the formula:
        ...
        \param[out] alignedSeq1 The final locally aligned result for
        the first sequence. This value is generated by this method.
    ...
    */
    ...
    /** Obtain result from performing Smith-Waterman local alignment
        using a fixed number of entries around the diagonal.
        ...
        \note This method delegates the task of computing the diagonal
        entries to the overloaded getSWAlignment(). Refer to the
        documentation on the overloaded method for additional details.
