...
\noindent {\bf Tool Runtime:} As \east\/ assembly requires the
...
\caption{Average runtime per trial for when generating data for
...
% LocalWords:  zebrafish runtimes ESTs paralilization
