...
\begin{figure}
  \centerline{\includegraphics[width=3in]{workflow.eps}}
...
produced by the \wcd\/ clustering tool \wc{(version 0.5.1)}\cite{Hazelhurst08a} and the
...
\begin{figure}
  \centerline{\includegraphics[width=3.35in]{SeT1.eps}}
...
\begin{figure}
  \centerline{\includegraphics[width=3in]{singletons.eps}}
